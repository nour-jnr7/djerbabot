...
openai.api_key  = "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"
...
def get_weather():
    ...
    url = (
        ...
        f"&current_weather=true"  # Corrigé : ¤t_weather → current_weather
    )
    try:
    ...
    if lieu_selectionne:
        ...
        try:
            ...
            with col1:
                ...
                if images:
                    st.image(images[0], caption=title, use_column_width=True)
            with col2:
